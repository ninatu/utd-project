...
def build_bert(model_config, pretrain, checkpoint):
    ...
    # bert_config.encoder_width = model_config.vision_encoder.get.d_model if model_config.vision_encoder.get('d_model', 0) else model_config.vision_encoder.embed_dim # TODO (Nina)
    bert_config.encoder_width = model_config.vision_encoder.embed_dim
