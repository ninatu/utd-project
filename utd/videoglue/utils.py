...
# Modified version of LabelSmoothingCrossEntropy, robust to infinite numbers in loss
# https://github.com/huggingface/pytorch-image-models/blob/055a600ed9d455a40fc44b1313a11e72933d7331/timm/loss/cross_entropy.py#L11
...
# Modified vestion of SoftTargetCrossEntropy, robust to infinite numbers in loss
# https://github.com/huggingface/pytorch-image-models/blob/055a600ed9d455a40fc44b1313a11e72933d7331/timm/loss/cross_entropy.py#L29
        ...
        ds_config = {
            ...
            "optimizer": {
                ...
                "params": {
                    ...
                    "betas": [0.9, 0.999] if args.opt_betas is None else args.opt_betas,
                    "eps": args.opt_eps
                }
            },
        }
        if args.deepspeed_mixed_precision_type in ['fp16', 'bf16']:
            ds_config[args.deepspeed_mixed_precision_type] =  {
                "enabled": True,
                "loss_scale": 0,
                "initial_scale_power": 7,
                "loss_scale_window": args.deepspeed_loss_scale_window
            }
        elif args.deepspeed_mixed_precision_type == 'fp32':
            ds_config['fp16'] = {
                "enabled": False,
            }
            ds_config['bp16'] = {
